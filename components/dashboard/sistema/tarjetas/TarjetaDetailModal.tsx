...
/**
 * Componente modal de sólo lectura para mostrar información detallada
 * y el historial cronológico de cambios de una tarjeta seleccionada.
 */
        ...
        <HStack gap={4} align="center">
          ...
          <VStack align="start" gap={1}>
            ...
            <HStack gap={2} mt={1} wrap="wrap">
              <Badge
                colorPalette={
                  isDeleted ? "gray" : getBadgeColor(tarjeta.estado)
                }
                variant="solid"
                borderRadius="full"
                textTransform="uppercase"
    ...
    >
      <VStack align="stretch" gap={5} w="full" pt={4} pb={4} flex="1" minH="0">
            ...
            <VStack align="start" gap={2}>
              ...
              <VStack align="start" gap={1}>
                <HStack fontSize="xs" color="gray.600">
                  <Calendar size={12} />
                  <Text>
                    <strong>Registro:</strong> {formatDate(tarjeta.creado_el)}
                  </Text>
                </HStack>
                {tarjeta.asignada_el && (
                  <HStack fontSize="xs" color="gray.600">
                    ...
                    <Text>
                      ...
                      {formatDate(tarjeta.asignada_el)}
                    </Text>
                  </HStack>
                )}
              </VStack>
        ...
        >
          ...
          {tarjeta.historial_asignaciones &&
          tarjeta.historial_asignaciones.length > 0 ? (
            <VStack
              align="stretch"
              gap={2}
              flex="1"
